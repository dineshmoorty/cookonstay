...
export default function Hero() {
  return (
    <section className="relative isolate overflow-hidden bg-[#fffdf8]">
      ...
      />
      <div className="mx-auto grid w-full min-h-[calc(100svh-5rem)] max-w-[80rem] items-center gap-12 px-6 py-16 sm:px-8 sm:py-20 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] lg:gap-20 lg:py-20">
        <HeroContent />
        <HeroImage />
      </div>
    </section>
