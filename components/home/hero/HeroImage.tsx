...
export default function HeroImage() {
  return (
    <div className="relative mx-auto w-full max-w-2xl pt-3 lg:max-w-none lg:pt-0">
      ...
      <div className="relative overflow-hidden rounded-[2rem] border border-white/80 bg-green-950 shadow-[0_24px_60px_-22px_rgba(31,41,55,0.35)] sm:rounded-[2.5rem]">
        <Image
          ...
          className="aspect-[1.12/1] w-full object-cover object-center transition duration-700 motion-safe:scale-[1.02] motion-safe:hover:scale-[1.06]"
        />
      ...
      <div className="hero-float absolute -right-2 top-7 hidden items-center gap-2 rounded-2xl border border-green-100 bg-white/95 px-3.5 py-3 text-sm font-semibold text-green-800 shadow-lg shadow-green-950/10 backdrop-blur-md sm:flex lg:-right-5 lg:top-10">
